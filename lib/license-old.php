...
if (!class_exists('Plugin_Licensing')):
    ...
    class Plugin_Licensing {
        ...
        public function license_response($response) {
            ...
            $status = empty($response["activated"]) ? '' : $response["activated"];
            ...
            if (!empty($status) && $status == true || $response == 'valid') {
                ...
                $response = __('<div class="license-activated alert alert-success"><p><strong>License Activated</strong><br/> Thank you for purchasing Yelp Widget Pro Premium' . $message . '</p></div>', 'ywp');
