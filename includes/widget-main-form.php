...
<div class="toggle-api-option-2 toggle-item  <?php if ($displayOption == "1") echo 'toggled'; ?>">
    ...
    <div class="reviews-toggle-container <?php if ($reviewsOption == "1") echo 'toggled'; ?>">
...
<div class="advanced-options toggle-item">
    ...
    <p>
        ...
        <input type="radio" name="<?php echo $this->get_field_name('google_map_position'); ?>" value="below" <?php checked('below', $googleMapPosition); if (empty($googleMapPosition)) echo "checked='checked'"; ?>><span class="yelp-method-label"><?php _e('Below Results', 'ywp'); ?></span><br>
...
<div class="advanced-options toggle-item">
    ...
    <p>
        <input id="<?php echo $this->get_field_id('target_blank'); ?>" name="<?php echo $this->get_field_name('target_blank'); ?>" type="checkbox" value="1" <?php checked('1', $targetBlank); ?> <?php if (empty($targetBlank)) echo "checked='checked'"; ?>/>
    ...
    <!-- No Follow Links -->
    <p>
        <input id="<?php echo $this->get_field_id('no_follow'); ?>" name="<?php echo $this->get_field_name('no_follow'); ?>" type="checkbox" value="1" <?php checked('1', $noFollow); ?> <?php if (empty($noFollow)) echo "checked='checked'"; ?> />
