...
<div class="yelp yelp-business <?php echo Yelp_Widget::ywp_profile_image_size($profileImgSize, 'class'); ?> yelp-business-api <?php echo "yelp-widget-" . $align; ?>"<?php if (!empty($width)) echo "style='width:" . $width . ";'"; ?>>
    ...
    if ($reviewsOption == '1') {
        ...
        <div class="yelp-business-reviews<?php if ($displayBizInfo === '1') echo " no-business-info"; ?>">
