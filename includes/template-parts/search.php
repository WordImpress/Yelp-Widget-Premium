 ...
 */
?>
<div class="yelp-widget-search-api <?php echo Yelp_Widget::ywp_profile_image_size($profileImgSize, 'class'); ?> <?php if(!empty($align)) echo "yelp-widget-" . $align; ?>" <?php if (!empty($width)) echo "style='width:" . $width . ";'"; ?>>
    <?php
